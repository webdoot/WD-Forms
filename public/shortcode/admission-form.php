...
<div class="w3-container w3-padding-32 w3-border">
  ...
  <form>
    ...
    <div class="w3-row-padding w3-padding-16">
      ...
      <input class="w3-input w3-border" type="number" name="mob_1" value="" placeholder="Mobile 1" required>
      </div>
      <div class="w3-third">
      <label>Mobile no 2</label>
      <input class="w3-input w3-border" type="number" name="mob_2" value="" placeholder="Mobile 2">
      </div>
    </div>
