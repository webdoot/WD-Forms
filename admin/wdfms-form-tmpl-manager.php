...
/**
 * Wd Form Template Manager
 */

add_action('wp_ajax_wdfms_tmpl_manage', 'wdfms_tmpl_manage');              
add_action('wp_ajax_nopriv_wdfms_tmpl_manage', 'wdfms_tmpl_manage');       

function wdfms_tmpl_manage(){
